...
- **macOS 14+:** download `Formiga-0.36.6-macOS-universal.dmg`, open it, and drag Formiga to
  Applications.
- **Windows 10/11:** download `Formiga-0.36.6-windows-x64.msi` and follow the installer. It adds
...
names with its version in place of `0.36.6`. The assisted updater matches those exact names, so do
