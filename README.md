...
- **macOS 14+:** download `Formiga-0.37.0-macOS-universal.dmg`, open it, and drag Formiga to
  Applications.
- **Windows 10/11:** download `Formiga-0.37.0-windows-x64.msi` and follow the installer. It adds
...
names with its version in place of `0.37.0`. The assisted updater matches those exact names, so do
