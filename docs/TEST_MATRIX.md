...
| Something to wear: every accessory made from a different find; only what the colony has found can be worn; put on, swapped, shared between two, taken off and put back, worn as a pin; a file naming something unfound wears nothing; every accessory shows on every body in every kind of pose and sits on the body; resting the pointer on any choice or pin, wearable or not, moves nothing in the menu, and a click puts on what was pointed at | CI | CI |
