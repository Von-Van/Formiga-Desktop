...
|---|---|---|---:|---:|---|
| v0.2.0 preview | local macOS test machine | pending native measurement | — | — | pending |
| v0.2.0 preview | Windows 10/11 test machine | pending native measurement | — | — | pending |
