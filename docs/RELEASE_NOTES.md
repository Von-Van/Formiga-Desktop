...
![A creature waving, exported as an animated sticker](assets/sticker-wave.gif)
...
![An exportable colony portrait showing every member, the village, and the month the colony began](assets/colony-card.png)
...
![Five body plans combined with six ear styles, with varied colors and markings](assets/generation-sheet.png)
...
![A colony house with companion cottages and objects, in four styles at both corners](assets/home-yard-sheet.png)
...
![Four shelter styles: plain, decorated, a cottage with its resident's curtain, and lit after dark](assets/shelter-sheet.png)
...
![Every style of house in its own colours and in each of the six named palettes](assets/village-palette-sheet.png)
